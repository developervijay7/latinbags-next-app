          ...
          <div className="max-w-[330px] w-full">
            ...
            <ul className="flex flex-col gap-3">
              <li className="flex gap-4.5">
                ...
                D-909, HIG 100Ft. Road, Kalindi Vihar, Agra - 282006
              </li>

              <li>
                <a href="tel:+919557654553" className="flex items-center gap-4.5">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
              ...
              <li>
                <a href="mailto:support@latinbags.com" className="flex items-center gap-4.5">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
        ...
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-5 flex-wrap items-center justify-between">
            <p className="text-gray-300 text-xs">
              &copy; {new Date().getFullYear()} LatinBags · Developed by{" "}
              <a
